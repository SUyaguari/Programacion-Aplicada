...
public class ControladorContrayente extends AbstractControlador<Persona>{
    ...
    private static ControladorContrayente instance = new ControladorContrayente();  
    ...
    **/
    public ControladorContrayente() {
        try {
            REGISTRO=239;
            archivo = new RandomAccessFile("/datos/contrayentes.txt", "rw");
            listar();
        } catch (FileNotFoundException ex) {
            System.out.println("Error lectura/escritura |Cotrolador contrayente|");
        }
    }
    ...
    public boolean updateArchivo(Persona persona) {
        ...
        try {
            ...
            System.out.println("Error lectura/escritura controlador Contrayente update");
        }
        return false;
    }
    ...
    public boolean deliteArchivo(Persona persona) {
        ...
        try {
            ...
            System.out.println("Error lectura/escritura controlador Contrayente delite");
            ex.printStackTrace();
