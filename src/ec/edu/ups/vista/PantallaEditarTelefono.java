...
public class PantallaEditarTelefono extends javax.swing.JFrame {
    ...
    Telefono aux;
    public PantallaEditarTelefono(ControladorTelefono controladorAgenda, Telefono telefono) {
        initComponents();
    ...
    private void jBtnAceptar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnAceptar2ActionPerformed
        ...
        if(numero.isEmpty() || tipo.isEmpty() || operadora.isEmpty()){
            JOptionPane.showMessageDialog(this, "Llene todos los campos");
        }else{
            
            controladorTelefono.update(new Telefono(codigo, numero, tipo, operadora, aux.getPersona()));
    ...
    public void llenarDatos(){
        jTextCodigo.setText(aux.getCodigo()+"");
        jTextNumero.setText(aux.getNumero());
        jTextTipo.setText(aux.getTipo());
        jTextOperadora.setText(aux.getOperadora());
    }
